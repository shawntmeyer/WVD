# ***************************************************************************
#
# Purpose: Install Microsoft Edge from Microsoft CDN
#
# ------------- DISCLAIMER -------------------------------------------------
...
[string]$scriptName = 'Install-MicrosoftEdge'
[String]$Script:LogDir = "$($env:SystemRoot)\Logs\Software"
[string]$Script:LogName = "$ScriptName.log"

If (-not (Test-Path $Script:LogDir)) {
    $null = New-Item -Path $env:SystemRoot\Logs -Name Software -ItemType Directory -Force
}
...
Write-Log -Message "Completed Microsoft Edge Install."
