...
$ScriptsStorageAccount = "shmeyerimagescripts"
...
#region Step 3: Create Azure Storage Account for storing the customization script blob.
If (!(Get-AzStorageAccount -ResourceGroupName $ImageResourceGroup -Name $ScriptsStorageAccount)) {
    New-AzStorageAccount -Name $ScriptsStorageAccount -ResourceGroupName $imageResourceGroup -Location (Get-AzResourceGroup -Name $imageResourceGroup).location -sku Standard_LRS
}
$StorageAccount = Get-AzStorageAccount -ResourceGroupName $ImageResourceGroup -Name $ScriptsStorageAccount
$ctx = $storageAccount.Context
$containerName = "aibcustomizationscripts"
